...
public class SpriteRand : MonoBehaviour {
	...
	public Sprite[] body_M, body_F, neck, head_normal_M, head_burning_M, head_normal_F, head_burning_F, lSleeve_M, lSleeve_F, lArm, rSleeve_M,rSleeve_F,rArm,crotch_M,crotch_F;
